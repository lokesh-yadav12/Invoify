...
export default async function LocaleLayout(props: {
    ...
    return (
        <html lang={locale} suppressHydrationWarning>
            ...
            <body
                className={`${outfit.className} ${dancingScript.variable} ${parisienne.variable} ${greatVibes.variable} ${alexBrush.variable} antialiased bg-slate-100 dark:bg-slate-800 min-h-screen flex flex-col`}
